    ...
    <section className="relative flex flex-col items-center justify-between py-4 lg:py-12">
      <div className="grid grid-cols-1 items-center md:grid-cols-2 lg:gap-12 gap-y-8">
        <div className="flex flex-col items-start justify-center rounded-lg p-3 lg:py-5 lg:px-12 bg-primary-bg h-full">
          ...
          <p className="text-gray-300 text-sm lg:text-base my-4 lg:my-6 text-center px-40">
            {profile.bio}
          </p>
          ...
          <div className="overflow-hidden border-t-[2px] border-indigo-900 px-4 lg:px-8 py-4 lg:py-8">
            <code className="font-mono text-xs md:text-sm lg:text-base">
              <div className="blink">
                ...
                <span className="mr-2 text-violet-400">profile_info</span>
              ...
              <div>
                ...
                <span className="text-gray-400">{`'`}</span>
                <span className="text-green-400">Ram Ortega</span>
                <span className="text-gray-400">{`',`}</span>
              </div>
              <div>
                <span className="ml-4 lg:ml-8 mr-2 text-white">company:</span>
                <span className="text-gray-400">{`'`}</span>
                <span className="text-green-400">GoodKredit Philippines Inc.</span>
                <span className="text-gray-400">{`',`}</span>
              </div>
              <div>
                <span className="ml-4 lg:ml-8 mr-2 text-white">location:</span>
                <span className="text-gray-400">{`'`}</span>
                <span className="text-green-400">Cebu City, Philippines</span>
                <span className="text-gray-400">{`',`}</span>
              </div>
              <div>
